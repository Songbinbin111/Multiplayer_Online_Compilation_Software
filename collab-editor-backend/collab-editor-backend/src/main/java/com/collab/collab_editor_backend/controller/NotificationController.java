...
public class NotificationController {
     ...
     */
    @GetMapping("/list")
    public Result<List<Notification>> getNotificationList(@RequestParam Long userId, @RequestParam(required = false) Boolean isRead) {
        try {
            List<Notification> notifications = notificationService.getByUserId(userId, isRead);
