...
public class DocumentVersionController {
    ...
    /**
     * 锁定/解锁文档版本
     * POST /api/version/lock
     */
    @PostMapping("/lock")
    public Result<?> lockVersion(@RequestParam Long versionId,
        ...
        return documentVersionService.lockVersion(versionId, isLocked, userId);
    }
     ...
     */
    @GetMapping("/diff")
    public Result<?> getVersionDiff(@RequestParam Long versionId1, @RequestParam Long versionId2) {
        return documentVersionService.getVersionDiff(versionId1, versionId2);
    }
}
